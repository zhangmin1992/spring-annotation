...
import day04TypeFilter.OtherDao;
...
public class App {
	...
	public static void main(String[] args) {
		...
		BookDao bean = (BookDao) applicationContext.getBean(BookDao.class);
		String[] beanmes = applicationContext.getBeanNamesForType(BookDao.class);
		for (String beanme : beanmes) {
			System.out.println("嗯嗯------------"+beanme);
		}
		bean.test();
