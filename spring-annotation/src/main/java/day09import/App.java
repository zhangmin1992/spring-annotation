...
public class App {
	...
	public static void main(String[] args) {
		/**
		 * spring给容器中注入bean的方式
		 * 1.在可扫描的包下有注解 @Service @Controller @Component @Repository，默认的名字是驼峰式的bookDao，可通过@Service("dd") 修改
		 * 2.在配置类中 @Bean 定义某个组件，默认的名字是方法名，可通过@Bean(name="ww")修改
		 * 
		...
		//Dog bean = (Dog) applicationContext.getBean("day09import.Dog");
		bean.jiao();
	}
