package day49ForMybatisDiscriminator.wanneng;
...
import day49ForMybatisDiscriminator.entity.BaseEntity;
import day49ForMybatisDiscriminator.zidingyi.DefaultEnumTypeHandler;

public class ScanEnumSqlSessionFactoryBean extends SqlSessionFactoryBean
	  ...
	  protected SqlSessionFactory buildSqlSessionFactory() throws IOException {
		...
		if (this.enumBasePackage != null && this.aliasBasePackage.trim().length() > 0) {
			ResolverUtil<Class<?>> resolverUtil = new ResolverUtil<Class<?>>();
			resolverUtil.find(new ResolverUtil.IsA(DisplayedEnum.class), this.enumBasePackage);
			Set<Class<? extends Class<?>>> mTypes = resolverUtil.getClasses();
			for (Class<?> javaTypeClass : mTypes) {
